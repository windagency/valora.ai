...
// Inlined from the host's `config/constants` to keep this leaf module
// self-contained at the package boundary.
const MS_PER_SECOND = 1000;
const COMMAND_EXISTENCE_CHECK_TIMEOUT_MS = 5 * MS_PER_SECOND;
const HEALTH_CHECK_INTERVAL_MS = 5 * MS_PER_SECOND;
