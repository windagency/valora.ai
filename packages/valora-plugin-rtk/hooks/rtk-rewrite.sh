...
RTK_TOOLS="git cargo npm docker kubectl make python pip yarn bun pnpm npx bunx tsc eslint vitest jest pytest ruff go rake rspec rubocop bundle prisma aws golangci-lint playwright next biome"
