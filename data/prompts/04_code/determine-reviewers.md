...
```json
{
	...
	"reviewer_rationale": {
		"alice": {
			"username": "alice",
			"reasons": ["CODEOWNERS for /auth/ directory", "Security domain expert"],
			"confidence": "high",
			"priority": 1
		},
		"bob": {
			"username": "bob",
			"reasons": ["Top contributor to src/auth/oauth2.ts (12 commits)", "Recent activity in authentication module"],
			"confidence": "medium",
			"priority": 2
		}
	},
