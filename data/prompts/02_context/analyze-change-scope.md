...
```json
{
	...
	"risk_level": "medium",
	"risk_factors": ["Affects authentication (critical area)", "Medium-sized change (145 LOC)", "No tests added"],
	"magnitude": "medium",
	"files_by_area": {
...
```json
{
	...
	"risk_level": "high",
	"risk_factors": ["Breaking change in public API", "Affects authentication (critical)", "Large change (450 LOC)"],
	"magnitude": "large",
	"files_by_area": {
