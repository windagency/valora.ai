...
```json
{
	...
	"scope": {
		"in_scope": ["Email verification endpoint", "Token generation and validation", "Email templates"],
		"out_of_scope": ["SMS verification", "Social login integration"]
	},
	"success_criteria": [
...
```json
{
	"comparison": {
		...
		"improvements": ["Risk coverage increased", "Step clarity improved"],
		"regressions": []
	}
}
```
