...
```json
{
	...
	"test_coverage_delta": {
		...
		"uncovered_files": ["src/auth/token-refresh.ts", "src/utils/crypto.ts"],
		"recommendations": ["Add tests for token-refresh.ts", "Add tests for crypto.ts (security-sensitive)"]
	},
	"complexity_metrics": {
		"files_changed": 15,
		"lines_added": 342,
	...
	"dependencies_changed": {
		"has_changes": true,
		"added": [{ "name": "oauth2-client", "version": "3.2.1", "type": "production" }],
		"removed": [],
		"updated": [
			{
				"name": "jsonwebtoken",
