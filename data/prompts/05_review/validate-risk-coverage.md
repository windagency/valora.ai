...
```json
{
	"critical_recommendations": ["Add mitigation strategy for data loss risk (RISK-003)"],
...
```json
{
	...
	"red_flags": ["High-severity risk RISK-002 has vague mitigation"],
	"recommendations": {
		"critical": ["Add detailed mitigation for RISK-002 with specific rollback trigger"],
		"important": [
		...
		"minor": ["Consider compliance risks for token storage"]
	}
}
```
