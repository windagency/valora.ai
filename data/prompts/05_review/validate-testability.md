...
```json
{
	...
	"breakdown": {
		"specific": {
			...
			"passing_criteria": 19,
			"total_criteria": 20,
			"issues": ["Criterion 12: 'Search works smoothly' is too vague"]
		},
		"measurable": {
			"score": 0.9,
			"passing_criteria": 18,
			"total_criteria": 20,
			"issues": ["Criterion 12: 'Smoothly' not quantified", "Criterion 15: 'Quick response' needs target value"]
		},
		"testable": {
			"score": 0.85,
			"passing_criteria": 17,
	...
	"test_strategy": {
		...
		"manual_tests": ["Visual design matches mockups", "Keyboard navigation functional", "Screen reader compatibility"],
