...
{
	"next_steps": {
		"immediate": ["Proceed to implementation phase", "Use /implement or /implement step-by-step based on complexity"],
		...
		"before_merging": ["Ensure all tests pass", "Verify acceptance criteria met", "Complete E2E tests if not done"]
	},
...
{
	"next_steps": {
		"immediate": ["Address critical issues listed above", "Revise plan sections with low scores"],
		"focus_areas": [
		...
		"after_revision": ["Re-run /review-plan to validate improvements", "Ensure all critical issues resolved"]
	},
