...
```json
{
	"agent_improvements": [
		...
		},
		{
			...
			"issues_found": ["Test execution took 15 minutes (expected: 5 minutes)"],
			"suggestions": ["Optimize test setup/teardown", "Parallelize test suites", "Cache test dependencies"],
			"priority": "high",
	...
	"prompt_refinements": [
		{
			...
			"issues_found": ["Generated code had 2 linter errors"],
