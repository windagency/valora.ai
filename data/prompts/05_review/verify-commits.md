...
**If tagged**: 5. Review tag: `git show ${tag_name}` 6. Push with tags: `git push origin <branch> --follow-tags`

**If changelog updated**: 7. Review changelog: `head -50 CHANGELOG.md`

**If breaking changes**: 8. Create migration guide 9. Notify stakeholders 10. Plan deployment strategy
