        ...
        *)
            ...
            case "$prev" in
                ...
                --model)
                    ...
                    local models="claude-fable-5 claude-opus-4.8 claude-sonnet-5 claude-sonnet-4.6 claude-haiku-4.5 gpt-5.5 gemini-3.5-flash grok-4.3 kimi-k2.6 auto"
...
${commandsList}
    ...
    opts=(
        ...
        '--model[AI model]:model:(claude-fable-5 claude-opus-4.8 claude-sonnet-5 claude-sonnet-4.6 claude-haiku-4.5 gpt-5.5 gemini-3.5-flash grok-4.3 kimi-k2.6 auto)'
	...
	private async generateFishCompletion(): Promise<string> {
		...
		const optionsWithArgs = [
			{ desc: 'Session ID', long: 'session', values: '(ls ~/.valora/sessions 2>/dev/null)' },
			{
				...
				long: 'model',
				values:
					'claude-fable-5 claude-opus-4.8 claude-sonnet-5 claude-sonnet-4.6 claude-haiku-4.5 gpt-5.5 gemini-3.5-flash grok-4.3 kimi-k2.6 auto'
			},
