...
import { getDocsUrl } from 'config/constants';
...
export const ERROR_MESSAGES: Record<string, ErrorMessageTemplate> = {
	...
	CONFIGURATION_INVALID: {
		docsLink: getDocsUrl('/configuration'),
		fixes: [
