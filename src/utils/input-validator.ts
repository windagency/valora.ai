 ...
 */
const FORBIDDEN_WRITE_PATHS = ['.valora/', 'data/'] as const;
...
function createForbiddenPathError(operation: string, originalPath: string): Error {
	return new Error(
		`Cannot ${operation} files in protected folders (.valora/, data/) - these folders contain system configuration ` +
 ...
 * Throws an error if the path targets the .valora/ or data/ folders or other protected system paths.
 *
