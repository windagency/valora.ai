...
import { ResourceAllocator } from 'exploration/resource-allocator';
...
describe('Docker Integration Tests', () => {
	...
	beforeAll(async () => {
		...
		stateManager = new ExplorationStateManager(path.join(testRepoDir, '.valora', 'explorations'));
	...
	describe('ContainerManager', () => {
		...
		it('should create and start a container', async ({ skip }) => {
			...
			const containerId = await containerManager.createContainer({
				...
				shared_volume_path: path.join(testRepoDir, '.valora', 'explorations', 'shared'),
