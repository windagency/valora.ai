...
describe('activity taxonomy architecture', () => {
	it('every valora-plugin-* package with a plugin manifest maps to a known (non-Other) activity', () => {
		...
		for (const dir of dirs) {
			...
			// Skip packages that are infrastructure/library packages (no plugin manifest)
