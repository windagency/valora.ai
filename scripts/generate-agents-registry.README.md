...
scripts/generate-agents-registry.sh

# Dry run (preview output without writing files)
scripts/generate-agents-registry.sh --dry-run
```
...
# Preview changes
scripts/generate-agents-registry.sh --dry-run | jq '.capabilities | keys'
```

## Output

The script generates `data/agents/registry.json` with this structure:
