...
if [[ ! "$PERIOD" =~ ^(7d|30d)$ ]]; then
  echo "❌ Error: Period must be '7d' or '30d'" >&2
  exit 1
fi

echo "📊 Generating metrics report for period: $PERIOD"
echo ""

# Generate metrics
echo "🔍 Extracting metrics from session logs..."
METRICS_JSON=$(mktemp)
...
echo "✓ Workflows analyzed: $WORKFLOWS"
...
echo ""
echo "✅ Report generated: .valora/METRICS_REPORT.md"
echo ""

# Display summary
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📊 METRICS SUMMARY ($PERIOD)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "  ├─ Templates:     ${TEMPLATE_RATE}% (target: 40%)"
echo "  ├─ Early Exit:    ${EARLY_EXIT_RATE}% (target: 30%)"
echo "  └─ Express:       ${EXPRESS_RATE}% (target: 15%)"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
if [[ "$CREATE_ISSUE" == true ]]; then
  if ! command -v gh &> /dev/null; then
    echo "⚠️  Warning: gh CLI not found. Install from: https://cli.github.com/" >&2
    echo "    Skipping issue creation." >&2
  else
    echo "📝 Creating GitHub issue..."

    # Extract sections from report
    SUMMARY=$(awk '/## Executive Summary/,/---/' .valora/METRICS_REPORT.md | sed '1d;$d')
    RECOMMENDATIONS=$(awk '/## Recommendations/,/---/' .valora/METRICS_REPORT.md | sed '1d;$d')

    # Create issue body
    ISSUE_BODY=$(cat <<EOF
# 📊 Weekly Workflow Metrics Report
...
View the complete metrics dashboard: [.valora/METRICS_REPORT.md](.valora/METRICS_REPORT.md)
...
EOF
    ...
    # Create issue
    gh issue create \
      --title "📊 Weekly Metrics Report - $(date -u +%Y-%m-%d)" \
      --body "$ISSUE_BODY" \
...
echo ""
echo "Next steps:"
echo "  • Review the report: cat .valora/METRICS_REPORT.md"
echo "  • Commit changes: git add .valora/METRICS_REPORT.md && git commit"
if [[ "$CREATE_ISSUE" == false ]]; then
  echo "  • Create issue: $0 $PERIOD --issue"
fi
echo ""
