...
- ✅ **Commands** (all command definitions in `data/commands/` and `.valora/commands/`)
- ✅ **Agents** (all agent definitions in `data/agents/` and `.valora/agents/`)
- ✅ **Prompts** (all prompt files in `data/prompts/` and `.valora/prompts/`)
- ✅ **Templates** (all templates in `data/templates/` and `.valora/templates/`)
...
**Prompts** (`.md` files in `data/prompts/*/*.md`):

- Use American English spelling
- Maintain technical consistency
- Keep aligned with templates

**Templates** (`.md` files in `data/templates/`):
