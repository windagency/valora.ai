...
- Has a specification file in `data/commands/` (built-in) or `.valora/commands/` (project overrides)
...
- Defined in `data/agents/` (built-in) or `.valora/agents/` (project overrides)
