...
- `data/prompts/05_review/synthesize-plan-assessment.md`
- `data/commands/review-plan.md`
...
- `data/prompts/05_review/validate-technical-feasibility.md`
- `data/prompts/05_review/validate-risk-coverage.md`
...
- `data/templates/plans/PATTERN_REST_API.md`
- `data/templates/plans/PATTERN_REACT_COMPONENT.md`
- `data/templates/plans/PATTERN_DATABASE_MIGRATION.md`
- `data/templates/plans/README.md`

**Files modified**:

- `data/prompts/03_plan/assess-complexity.md` (pattern detection logic)
- `data/commands/plan.md` (template usage documentation)
...
- `data/commands/review-plan.md` - Added `parallel: true` to step-quality stage
...
- `data/prompts/04_code/implement-changes.md` - Added Step 3 (validation), updated success criteria and rules
...
- `data/prompts/03_plan/breakdown-implementation.md` - Added Step 0 (express planning)
...
- Created `data/templates/standards/TECHNICAL_DEFAULTS.md`
- **Content includes**:
...
- `data/templates/standards/TECHNICAL_DEFAULTS.md` - 500+ lines of defaults

**Files modified**:

- `data/prompts/01_onboard/refine-specifications.md` - Added defaults reference
- `data/prompts/07_documentation/generate-prd.md` - Added defaults reference
...
**See**: `documentation/architecture/metrics-dashboard.md` for complete metrics tracking system

**Quick Commands**:

```bash
# Extract last 30 days of metrics
pnpm tsx scripts/extract-metrics.ts 30d > metrics.json

# Generate visual dashboard
pnpm tsx scripts/extract-metrics.ts 30d | \
  pnpm tsx scripts/generate-dashboard.ts
...
```bash
git checkout HEAD~1 data/prompts/05_review/synthesize-plan-assessment.md
git checkout HEAD~1 data/prompts/05_review/validate-technical-feasibility.md
git checkout HEAD~1 data/prompts/05_review/validate-risk-coverage.md
```
...
- **Template Documentation**: `data/templates/plans/README.md`
- **Plan Command**: `data/commands/plan.md`
- **Review Command**: `data/commands/review-plan.md`
