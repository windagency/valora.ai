...
### Lead Engineer (`data/agents/lead.md`)
...
### Backend Engineer (`data/agents/software-engineer-typescript-backend.md`)
...
### Frontend Engineer (`data/agents/software-engineer-typescript-frontend.md`)
...
### Platform Engineer (`data/agents/platform-engineer.md`)
...
### SecOps Engineer (`data/agents/secops-engineer.md`)
...
- **Inheritance:** Inherits all `data/agents/platform-engineer` capabilities but with an 80% confidence escalation threshold.
- **Ethics:** Strictly bound by responsible disclosure and zero-trust principles.

### QA Engineer (`data/agents/qa.md`)
